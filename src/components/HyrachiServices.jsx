                ...
                <div>
                    ...
                    <AutoScroll speed={10} pauseOnHover={true}>
                        <div className="flex flex-nowrap gap-2 overflow-x-auto whitespace-nowrap pl-3">
                            <button
                                onClick={() => handleServiceClick("💇 Hair Services")}
                                className="text-xs font-medium text-indigo-700 border-2 border-indigo-300 p-2 rounded-lg shadow-sm hover:bg-indigo-50 hover:border-indigo-400 transition-all cursor-pointer"
                            >
                                💇 Hair Services
                            </button>
                            <button
                                onClick={() => handleServiceClick("💆 Facial Services")}
                                className="text-xs font-medium text-indigo-700 border-2 border-indigo-300 p-2 rounded-lg shadow-sm hover:bg-indigo-50 hover:border-indigo-400 transition-all cursor-pointer"
                            >
                                💆 Facial Services
                            </button>
                            <button
                                onClick={() => handleServiceClick("💅 Manicure Services")}
                                className="text-xs font-medium text-indigo-700 border-2 border-indigo-300 p-2 rounded-lg shadow-sm hover:bg-indigo-50 hover:border-indigo-400 transition-all cursor-pointer"
                            >
                                💅 Manicure Services
                            </button>
                            <button
                                onClick={() => handleServiceClick("🦶 Pedicure Services")}
                                className="text-xs font-medium text-indigo-700 border-2 border-indigo-300 p-2 rounded-lg shadow-sm hover:bg-indigo-50 hover:border-indigo-400 transition-all cursor-pointer"
                            >
                                🦶 Pedicure Services
                            </button>
